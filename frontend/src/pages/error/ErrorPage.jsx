...
const ErrorPage = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center min-h-screen bg-gradient-to-br from-retroblue to-darkblue text-white">
      ...
      <FaExclamationTriangle size={60} className="text-yellow-300 mb-6 animate-bounce" />
        ...
        <p className="text-md mb-8">It seems the page you are looking for does not exist or has been moved. Please check the URL or go back to the home page.</p>
        <button
